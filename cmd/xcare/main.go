...
// xcare is the official command-line client for Ethereum.
package main
...
const (
	clientIdentifier = "xcare" // Client identifier to advertise over the network
)
...
// xcare is the main entry point into the system if no special subcommand is ran.
