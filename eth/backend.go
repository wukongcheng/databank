...
import (
	...
	"github.com/wukongcheng/databank/consensus/clique"
	...
	"github.com/wukongcheng/databank/eth/filters"
	...
	"github.com/wukongcheng/databank/miner"
...
func New(ctx *node.ServiceContext, config *Config) (*Ethereum, error) {
	...
	if eth.protocolManager, err = NewProtocolManager(eth.chainConfig, eth.config.ConfigHash, config.SyncMode, config.NetworkId, eth.eventMux, eth.txPool, eth.engine, eth.blockchain, chainDb); err != nil {
		return nil, err
	}
